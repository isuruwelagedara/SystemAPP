...
<div id="buot"  class="row center">
    ...
    if($user_type == "admin") {
        ...
        <div class=" col m3">
            <a class="waves-effect waves-light btn-large light-blue"href="#modal4"><i class="material-icons left">face</i>Create a user</a>
        </div>';
    }
    ?>
...
<div id="modal1" class="modal modal-fixed-footer">
    ...
    <div class="modal-content">
        <h6 class="center">Apply for a Leave</h6>
                        ...
                        <div class="input-field col m6">
                            <select id="coverup"onChange="myNewFunction(this);">
                                ...
                                foreach ($list as $rs) {
                                    ...
                                    echo '<option value=\"'.$rs['id'].'\"> '.$rs['name_ini'].'</option>';
                                }
...
<div id="modal2" class="modal modal-fixed-footer">
    <div class="row">
        ...
        <div class="col s12">
            ...
            <button class="btn waves-effect waves-light green"  type="submit" id ="acccpt-submit" name="acceptbutton" value ="1">Accept

            </button>
            <div class="demoo-container">
...
<div id="modal4" class="modal modal-fixed-footer">
    ...
    <script src="appjs/test.js"></script>
