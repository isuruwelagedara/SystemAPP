...
///////// finding the user name and epf no
...
///////// finding the manager's name and epf no
    ...
    foreach ($results as $row) {
        ...
        $manager_name = $row['name_ini'];
		$manager_email = $row['email'];
        
    }	
///////// finding the reson from applyleave
...
//
//////Sanka///
$image_path = $path_of_webpage.''.$epf_no.'.png';  //getting $path_of_webpage from emailconfig php and get $epf number from applyleave.php
...
$mail->Subject = 'Headstart Leave System - Request';
                            ...
                            <tr>
                                <td style="word-wrap:break-word;font-size:0px;padding:0px 18px 0px 18px;" align="center">
                                    <div style="cursor:auto;color:#FF0000;font-family:Roboto, Tahoma, sans-serif;font-size:11px;line-height:22px;text-align:center;">
                                        <p>
                                            <span style="font-size:48px;">Hello,'.$manager_name.'</span>
                                        </p>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td style="word-wrap:break-word;font-size:0px;padding:0px 20px 0px 20px;" align="center">
                                    <div style="cursor:auto;color:#5F5F5F;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:11px;line-height:22px;text-align:center;">
                                        <p>
                                            <span style="font-size:22px;">'.$user_name.' is requesting a leave </span>
                                        </p>
                                    </div>
                                </td>
                            </tr>
